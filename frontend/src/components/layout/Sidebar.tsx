...
export function Sidebar() {
  ...
  return (
    <aside className={cn(
      'fixed left-0 top-0 z-40 h-screen border-r border-white/30 dark:border-white/8 bg-white/30 dark:bg-[hsl(220,14%,8%)]/90 backdrop-blur-xl transition-all duration-300 flex flex-col',
